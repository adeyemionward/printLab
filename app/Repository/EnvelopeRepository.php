<?php
    ...
    {
        public function postenvelope($data){
            DB::beginTransaction();
            try{
                $user = Auth::user();
        ...
        public function updateEnvelope($data){
            DB::beginTransaction();
            try{
                $id = request()->id;
                $user = Auth::user();
            ...
            return redirect(route('company.job_order.view_order',[request()->job_title,$id]))->with('flash_success', 'Enveloper Book order updated successfully');
        }

        public function updateCartEnvelope($data){
            DB::beginTransaction();
            try{
                $id = request()->job_id;
                $user = Auth::user();
