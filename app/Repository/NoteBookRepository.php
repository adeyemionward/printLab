...
use App\Models\TwentyLeavesBook;
    ...
    class NoteBookRepository
    {
        ...
        //         $total_cost                 =  str_replace(',', '',$data['total_cost']) ?? 0;
        //         $initial_amount_paid        =  str_replace(',', '',$data['amount_paid']) ?? 0;
    ...
    try{
        ...
        // If your update logic requires updating the original deposit amount, assign it safely here:
        // $job_order->initial_amount_paid = $amount_paid; 
