    ...
    class SubscriptionRepository
    {
        public function postSubscription($data){
            ...
            try{
                ...
                $company_sub =  Company::updateOrCreate(
                    [
                        'id'               => request('company_id'),
                    ],
                    [
                        'sub_amount'       => $sub_plan->amount ?? 0,
        ...
        public function updateSubscription($data){
            ...
            return redirect(route('admin.subscriptions.active'))->with('flash_success','Subscription updated successfully');
        }
