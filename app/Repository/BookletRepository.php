<?php
    ...
    class BookletRepository
    {
        ...
        public function updateBooklet($data){
            ...
            return redirect(route('company.job_order.view_order',[request()->job_title,$id]))->with('flash_success', 'Booklet order updated successfully');
        }


        public function updateCartBooklet($data){
            DB::beginTransaction();
            try{
                $id = request()->job_id;
                $user = Auth::user();
