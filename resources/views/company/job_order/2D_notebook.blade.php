...
@section('content')
@section('title', '2D_NoteBook')
@php $page = '2d_notebook' @endphp
                                ...
                                <div class="col-md-9 col-xl-9">
                                    <div class="card">
                                        <div class="card-header bg-white">
                                            <h5 class="card-title mb-0 text-muted">Create 2D NoteBook Job Order</h5>
                                        </div>
                                                                ...
                                                                <form method="POST"  id="add_2d_notebook" class="add_2d_notebook">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            ...
                                                                            <select class="form-control form-select" name="payment_type" id="payment_type" required>
