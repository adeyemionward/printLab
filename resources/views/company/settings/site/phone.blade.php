                                                                ...
                                                                <form method="POST"  id="phone" class="phone" >
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            ...
                                                                            <input type="text" required name="phone_2" class="form-control{{ $errors->has('phone_2') ? ' is-invalid' : '' }}" value="{{ old('phone_2') ?? $site_details->phone_2 }}" id="phone_2">
                                                                            @error('phone_2')
                                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            ...
                                                                            <input type="text" required name="phone_3" class="form-control{{ $errors->has('phone_3') ? ' is-invalid' : '' }}" value="{{ old('phone_3') ?? $site_details->phone_3 }}" id="phone_3">
                                                                            @error('phone_3')
                                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                                            @enderror
                                                                        </div>
