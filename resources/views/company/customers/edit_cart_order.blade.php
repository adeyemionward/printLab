...
@php $page = 'edit_cart'; @endphp
    <div class="content">
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-6 float-start">
                    <h4 class="m-0 text-dark text-muted">Cart Job Order for {{$customer->firstname.' '.$customer->lastname}} </h4>
                </div>
                <div class="col-md-6">
                            ...
                            <div class="row">
                                @include('company.customers.side_inc')
                                  <div class="col-md-9 col-xl-9">
                                    @if($job_order->job_order_name == 'Higher NoteBook')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                                <h5 class="card-title mb-0 text-muted">Edit Higher Education Cart Order</h5>
                                            </div>
                                    ...
                                    @if($job_order->job_order_name == 'Small_Invoice')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                                ...
                                                <div class="align-items-start">
                                                    <div class="tab-content" id="nav-tabContent">
                                                        <div class="tab-pane fade show active" id="nav-server"
                                                            ...
                                                            <div class="row g-3 mb-3 mt-3">
                                                                <div class="col-md-12">
                                                                    <form method="POST"  id="small_invoice" class="small invoice">
                                                                        @csrf
                                                                        @method('POST')
                                                                        <div class="row">
                                                                            <div class="form-group mt-3 mb-3 col-md-4">
                                    ...
                                    @if($job_order->job_order_name == '2B NoteBook')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == '2D NoteBook')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Drawing Book')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                                <h5 class="card-title mb-0 text-muted">Edit Drawing Book Job Order</h5>
                                            </div>
                                            <div class="card-body h-100">
                                                <div class="align-items-start">
                                                    <div class="tab-content" id="nav-tabContent">
                                                            ...
                                                            <div class="row g-3 mb-3 mt-3">
                                                                <div class="col-md-12">
                                                                    <form method="POST"  id="add_drawing_book" class="add_drawing_book">
                                                                        @csrf
                                                                        @method('POST')
                                                                        <input type="hidden" name="note_type" value="Drawing Book">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group mt-3 mb-3 col-md-4">
                                                                                ...
                                                                                <select name="leaves" required class="form-control form-select"
                                                                                    id="exampleFormControlSelect1">
                                                                                    <option value="">--Select Leaves--</option>
                                                                                    <option value="10"  <?php if ($job_order->leaves == 10) echo 'selected' ?>>10 Leaves</option>
                                                                                    <option value="20"  <?php if ($job_order->leaves == 20) echo 'selected' ?>>20 Leaves</option>
                                                                                    <option value="40"  <?php if ($job_order->leaves == 40) echo 'selected' ?>>40 Leaves</option>
                                                                                </select>
                                                                            </div>
                                    ...
                                    @if($job_order->job_order_name == 'Twenty Leaves')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Booklet')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Brochures')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Envelopes')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Flyer')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Notepads')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Stickers')
                                        <div class="card">
                                            <div class="card-header bg-white">
                                    ...
                                    @if($job_order->job_order_name == 'Service')
                                        <div class="card">
                                            <div class="card-header bg-white">
