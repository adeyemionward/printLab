                                                                ...
                                                                <form method="POST"  id="add_twenty_leaves" class="add_twenty_leaves" enctype="multipart/form-data">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            ...
                                                                            <select required name="product_name" class="form-control{{ $errors->has('product_name') ? ' is-invalid' : '' }} form-select" value="{{ old('product_name') }}">
                                                                        ...
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            <label for="production_time">Upload Image</label>
                                                                        ...
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            ...
                                                                            <select required name="ink" class="form-control form-select"
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group mt-3 mb-3 col-md-4">
                                                                            <label for="production_time">Production Time (Days)</label> 
                                                                                <input  required type="number" name="production_time" class="form-control"
