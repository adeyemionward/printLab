                                                                    ...
                                                                    <table id="products">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="product-row">
                                                                                <td style="width:50%"><input type="text" required class="form-control state"  name="state[]" /></td>
                                                                                <td style="width:50%"><input type="text" required class="form-control city"  name="city[]" /></td>
