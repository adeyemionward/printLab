...
<form method="POST"  action="{{route('dashboard.admin.cooperative.loans.repayments.post')}}" class="">
    @csrf
    @method('POST')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Money for cooperative Loans Repayment </h5> <br>
...
{{-- end pay modal --}}
    ...
    <script>
        ...
        $(document).on('change', '#member-select', function() {
            ...
            $('#loading-icon').show();
            $.ajax({
                url: '/get-member-cooperative-loans/' + member_id,
                type: 'GET',
