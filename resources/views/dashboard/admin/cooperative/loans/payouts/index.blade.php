...
@section('content')
@section('title', 'All Cooperative Loans')
{{-- start pay modal --}}
<!-- CSS -->
...
<form method="POST"  action="{{route('dashboard.admin.cooperative.loans.payouts.post')}}" class="">
    @csrf
    @method('POST')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Money for cooperative Loans </h5> <br>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-12">
                        <label for="amount_paid">Amount Payout</label>
                        <input required type="number" name="amount_payout" class="form-control">
                    </div> <br>
                    <div class="form-group col-md-12">
                        <label for="date_paid">Payout Date</label>
        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-6 float-start">
                    <h4 class="m-0 text-dark text-muted">Cooperative Loans Payout</h4>
                </div>
                <div class="col-md-6">
                            ...
                            <tbody>
                                @forelse ($loan_payouts as $val)
                                    <tr>
                                        ...
                                        <td>
                                            {{'₦'.$val->amount_payout}}
                                            <p style="font-size: 12px">Repayment:
                                                <span style="color: green; font-weight:600">₦{{$val->amount_repayed}}</span>
                                            </p>
                                        </td>
