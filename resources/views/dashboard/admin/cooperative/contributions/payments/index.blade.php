...
@section('content')
@section('title', 'All Cooperative Payments')
{{-- start pay modal --}}
<!-- CSS -->
...
<form method="POST"  action="{{route('dashboard.admin.cooperative.contributions.payments.post')}}" class="">
    @csrf
    @method('POST')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLabel">Add Money for cooperative contributions payments </h6> <br>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group col-md-12">
                        <label for="backsided">Select the money Collector</label>
                        <select required class="form-control form-select"  name="collector_id" id="">
                            <option >--select a collector--</option>
                             @forelse ($staff as $val) {{--staf is from usertype provider --}}
                                <option value="{{$val->id}}">{{$val->firstname.' '.$val->lastname}}</option>
                            @empty
                                <option value="" disabled>No collector available</option>
                            @endforelse
                        </select>
                    </div> <br>
                    <div class="form-group col-md-12">
        ...
        <div class="container-fluid">
            <div class="row mt-2">
                <div class="col-md-6 float-start">
                    <h4 class="m-0 text-dark text-muted">Cooperative Contributions</h4>
                </div>
                <div class="col-md-6">
                            ...
                            <tbody>
                                @forelse ($contribution_payments as $val)
                                    <tr>
                                        ...
                                        <td>{{$val->staff->firstname. ' '.$val->staff->lastname}}</td>
