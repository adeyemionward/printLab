...
@section('content')
@section('title', 'All Cooperative Payouts')
{{-- start pay modal --}}
<!-- CSS -->
...
<form method="POST"  action="{{route('dashboard.admin.cooperative.contributions.payouts.post')}}" class="">
    @csrf
    @method('POST')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Send Money for cooperative contributions </h5> <br>
