...
<form method="POST"  action="{{route('dashboard.admin.savings.loans.payouts.post')}}" class="">
    @csrf
    @method('POST')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Money for savings Loans </h5> <br>
