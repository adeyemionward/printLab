            ...
            <div class="content">
                <div class="canvas-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                @include('dashboard.admin.parties.customer.side_inc')
                                                        ...
                                                        <div class="row g-3 ">
                                                            <div class="col-md-12">
                                                                <table width="100%"  class="details">
                                                                    <tr class="det">
                                                                      <td width="20%" class="question">Customer Id :</td>
                                                                      <td>{{$customer->id ?? 'N/A'}}</td>
                                                                    </tr>
                                                                    <tr class="det">
                                                                        <td width="20%" class="question">Customer Name :</td>
                                                                        <td>{{$customer->firstname.' '.$customer->lastname ?? 'N/A'}}</td>
                                                                    </tr>
                                                                    <tr class="det">
                                                                        <td width="20%" class="question">Phone :</td>
                                                                        <td>{{$customer->phone ?? 'N/A'}}</td>
                                                                    </tr>
                                                                    <tr class="det">
                                                                        <td width="20%" class="question">Address :</td>
                                                                        <td>{{$customer->address ?? 'N/A'}}</td>
                                                                    </tr>


                                                                    <tr>
                                                                        <td width="20%" class="question">Created By :</td>
                                                                        <td>{{@$customer->createdBy->firstname.' '.@$job_order->createdBy->lastname ?? 'N/A'}}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td width="20%" class="question">Created At :</td>
                                                                        <td>{{$customer->created_at ?? 'N/A'}}</td>
                                                                    </tr>


                                                                    <tr>
                                                                        <td width="20%" class="question">Updated By :</td>
                                                                        <td>{{@$customer->updatedBy->firstname.' '.@$job_order->updatedBy->lastname ?? 'N/A'}}</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td width="20%" class="question">Updated At :</td>
