                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="detail">
                                        ...
                                        <span class="number">{{$all_orders ?? null}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="detail">
                                        ...
                                        <span class="number">{{$pending_orders ?? null}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="footer">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <div class="detail">
                                        ...
                                        <span class="number">{{$delivered_orders ?? null}}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="footer">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        ...
                                                        <button class="btn"><a href="" style=" text-decoration: underline; color:rgb(5, 15, 64); padding:3px 20px 3px 20px">Clear</a>
                                                    </div>
