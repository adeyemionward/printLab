...
<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td height="69">
                                    <table width="500" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td width="50" height="29" style="font-weight:bolder; font-size:25px">
                                                <img src="https://printlabs.com.ng/img/printlab.PNG" alt="printlabs logo" width="180" title="printlabs logo" /> 
                                                <br><br>INVOICE
                                            </td>
                                            <td width="50" align="right" height="29" style="font-size:25px; padding-right:50px">
                                                <br> <span style="font-size: 16px">No 14 Akinremi street, Anifowoshe <br> Ikeja, Lagos</span>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
        ...
        <td>
            <table width="100%" border="1" cellpadding="0" cellspacing="0">
                ...
                @foreach ($orderDetails as $val)
                    @php 
                        // Strip out commas or any accidental characters, then cast to float safely
                        $cleanedCost = (float) str_replace(',', '', $val->total_cost);
                        $totalCost += $cleanedCost; 
                    @endphp
                    <tr style="border-bottom: 1px solid #ccc;">
                        ...
                        <td align="right" width="15" style="padding-right: 20px">#{{ number_format($cleanedCost, 2) }}</td>
                    </tr>
                @endforeach
            </table>
        </td>
    ...
    <tr>
        <td height="69">
            <table width="500" border="1" align="right" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="70" height="29" bgcolor="#E3E3E3" style="padding-left: 20px; padding-top:10px">
                        <span style="font-weight: bold"> 
                            75% of #{{ number_format($totalCost, 2) }}:&nbsp; (#{{ number_format((75 / 100) * $totalCost, 2) }}) must be paid before we can process your order
                        </span> <br><br>
                        <span style="font-weight: bold">BANK&nbsp;DETAILS</span> <br><br>
                        Bank : ECOBANK <br> Acc/No: NAIRA ACCOUNT: 4933060877 <br>Account Name: PRINTLABS LTD
                    </td>
                    <td width="30" align="right">&nbsp;<span style="font-size:20px; padding-right:10px"><span style="font-weight:bold; ">Total Amount:</span> #{{ number_format($totalCost, 2) }} </td>
                </tr>
            </table>
        </td>
    </tr>
