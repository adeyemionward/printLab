...
<title>PrintSoft | Printing software solution in Nigeria, Lagos, Benin city</title>
...
<li><a href="{{route('index')}}#our_solution">Our Solution</a></li>

<li><a href="{{route('contact.index')}}">Contact</a></li>
<li><a href="{{route('register')}}"><button type="submit" class="btn desktop_hide_acc_btn">Create Account</button></a></li>
</ul>
</nav>
</div>
...
<a href="{{route('register')}}"><button type="submit" class="btn mobile_hide_acc_btn">Create Account</button></a>
</ul>
</div>
</div>
