            ...
            <tr>
				<td>
					<table style="padding-left: 30px;" width="100%">
                        ...
                        <tr>
                            <td style="; font-weight: 600; padding-top: 20px;">Phone: {{$phone}}</td>
						</tr>
                        <tr>
                            <td style="; font-weight: 600; padding-top: 20px;">Subject: {{$title}}</td>
						</tr>
                        <tr>
                            <td style="; font-weight: 600; padding-top: 20px;">Message: {{$messagetext}}</td>
						</tr>
					</table>
