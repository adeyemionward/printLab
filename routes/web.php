        ...
        Route::group(['prefix' => '/company', 'as' => 'company.'], function () {
            Route::middleware(['checkRole:3'])->group(function () {
                ...
                Route::group(['prefix' => '/job_order', 'as' => 'job_order.'], function () {
                    ...
                    // Route::get('/consolidated_order_invoice_pdf/{order_no?}', 'JobOrderController@consolidatedOrderInvoicePdf')->name('consolidated_order_invoice_pdf');
                    Route::get('/higher_education/{id?}', 'JobOrderController@higher_education')->name('higher_education');
                    Route::post('/higher_education/{id?}', 'JobOrderController@post_higher_education')->name('higher_education');
